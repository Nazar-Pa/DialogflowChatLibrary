...
//        LinearLayout.LayoutParams.MATCH_PARENT
        LinearLayout.LayoutParams btnParam = new LinearLayout.LayoutParams(200, LinearLayout.LayoutParams.WRAP_CONTENT, 0.5f);
...
//                    }
                            if (!eventName.trim().isEmpty()) {
                                if ((text.equals("Give motivation"))) {
                                    msgBuilder.setEventName("motivation_intent");
