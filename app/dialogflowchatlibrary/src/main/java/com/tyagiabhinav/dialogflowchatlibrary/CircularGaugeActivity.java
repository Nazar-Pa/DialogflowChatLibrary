...
public class CircularGaugeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        step = ChatbotActivity.stepCount;
        int stepPercent = (step*100)/1000;
        String stepNum = Integer.toString(step);
        String stepPerc = Integer.toString(stepPercent);

        CircularGauge circularGauge = AnyChart.circular();
        circularGauge.data(new SingleValueDataSet(new String[] { stepPerc, "34", "67", "93", "56", "100"}));
...
//                .useHtml(true);
    ...
    private void show() {
        step = ChatbotActivity.stepCount;
        String stepNum = Integer.toString(step);
        Toast.makeText(this, stepNum, Toast.LENGTH_LONG).show();
    }
}
